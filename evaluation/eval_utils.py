...
class CustomRetrievalEvaluator:
    ...
    def evaluate(
        ...
        results_for_abstention = {qid: results[qid] for qid in scores.keys() if qid in results}
        naucs = RetrievalEvaluator.evaluate_abstention(
            results_for_abstention, {**all_ndcgs, **all_aps, **all_recalls, **all_precisions}
        )
    ...
    def evaluate_custom(
        ...
        results_for_abstention = {qid: results[qid] for qid in qrels.keys() if qid in results}
        naucs = RetrievalEvaluator.evaluate_abstention(results_for_abstention, metric_scores)

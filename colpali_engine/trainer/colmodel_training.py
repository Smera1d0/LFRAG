...
from colpali_engine.utils.dataset_transformation import JsonlCropDataset 
...
class ColModelTrainingConfig:
    ...
    train_dataset: Union[JsonlCropDataset, List[JsonlCropDataset]] 
    eval_dataset: Optional[Union[JsonlCropDataset, Dict[str, JsonlCropDataset]]] = None 
    ...
    def __post_init__(self):
        ...
        print("peft_config:", self.peft_config)
